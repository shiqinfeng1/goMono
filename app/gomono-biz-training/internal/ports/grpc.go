...
import (
	...
	conf "github.com/shiqinfeng1/goMono/app/gomono-biz-training/internal/conf"
...
func NewGRPCServer(ctx context.Context, srvInfo *types.SrvInfo, c *conf.GRPC, logger log.Logger, tr *cconf.Trace, training service.GrpcService) *grpc.Server {
