...
func RegisterTrainingServiceHTTPServer(s *http.Server, srv TrainingServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/training/v1/getTraining", _TrainingService_GetTraining0_HTTP_Handler(srv))
	r.POST("/training/v1/createTraining", _TrainingService_CreateTraining0_HTTP_Handler(srv))
	r.POST("/training/v1/cancelTraining", _TrainingService_CancelTraining0_HTTP_Handler(srv))
	r.POST("/training/v1/rescheduleTraining", _TrainingService_RescheduleTraining0_HTTP_Handler(srv))
	r.POST("/training/v1/approveRescheduleTraining", _TrainingService_ApproveRescheduleTraining0_HTTP_Handler(srv))
	r.POST("/training/v1/requestRescheduleTraining", _TrainingService_RequestRescheduleTraining0_HTTP_Handler(srv))
	r.POST("/training/v1/rejectRescheduleTraining", _TrainingService_RejectRescheduleTraining0_HTTP_Handler(srv))
}

func _TrainingService_GetTraining0_HTTP_Handler(srv TrainingServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationTrainingServiceGetTraining)
...
func (c *TrainingServiceHTTPClientImpl) GetTraining(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*GetTrainingResponse, error) {
	var out GetTrainingResponse
	pattern := "/training/v1/getTraining"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationTrainingServiceGetTraining))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
