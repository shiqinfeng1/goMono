...
func IsGreeterUnspecified(err error) bool {
	...
	return e.Reason == UserErrorReason_GREETER_UNSPECIFIED.String() && e.Code == 500
}

func ErrorGreeterUnspecified(format string, args ...interface{}) *errors.Error {
	return errors.New(500, UserErrorReason_GREETER_UNSPECIFIED.String(), fmt.Sprintf(format, args...))
}
