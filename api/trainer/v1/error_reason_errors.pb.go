...
func IsTrainerUnspecified(err error) bool {
	...
	return e.Reason == TrainerErrorReason_TRAINER_UNSPECIFIED.String() && e.Code == 500
}

func ErrorTrainerUnspecified(format string, args ...interface{}) *errors.Error {
	return errors.New(500, TrainerErrorReason_TRAINER_UNSPECIFIED.String(), fmt.Sprintf(format, args...))
}
